...
const TRANSLATIONS = {
  fr: {
    ...
    home: {
      ...
      mission_teaser: 'Notre rôle : agréger, vérifier et publier les données du Tchad en libre accès.',
      ...
      pipeline_teaser: 'De la collecte brute à la publication : trois étapes de contrôle qualité.',
      pipeline: [
      ...
      sources_strip_label: 'Données agrégées depuis :',
    ...
    // ── Insights ──
    insights: {
      agent_log:   'AGENT D\'ANALYSE AUTOMATISÉE',
      title:       'RAPPORTS D\'ANALYSE AUTOMATISÉS',
      subtitle:    'EXPLORATION AUTOMATISÉE DE LA BASE & GÉNÉRATION DE RAPPORTS',
      ...
      studies_title:   'Rapports d\'Analyse Automatisés',
      btn_run:         'GÉNÉRER UN RAPPORT ANALYTIQUE',
      btn_run_loading: 'EXÉCUTION DE L\'AGENT DE SYNTHÈSE…',
      btn_run_new:     'GÉNÉRER UN NOUVEAU RAPPORT',
      placeholder:     'Cliquez sur "GÉNÉRER UN RAPPORT ANALYTIQUE" pour exécuter l\'Agent sur les données en base.',
      running_msg:     'L\'AnalysisAgent analyse les données pour le secteur',
      result_badge:    'RAPPORT GÉNÉRÉ EN BASE',
      result_model:    'MODÈLE',
  ...
  en: {
    ...
    home: {
      ...
      mission_teaser: 'Our role: aggregate, verify, and openly publish data about Chad.',
      ...
      pipeline_teaser: 'From raw collection to publication: three quality-control stages.',
      pipeline: [
      ...
      sources_strip_label: 'Data aggregated from:',
    ...
    insights: {
      agent_log:   'AUTOMATED ANALYSIS AGENT',
      title:       'AUTOMATED ANALYTICAL REPORTS',
      subtitle:    'AUTOMATED DATABASE EXPLORATION & REPORT GENERATION',
      ...
      studies_title:   'Automated Analytical Reports',
      btn_run:         'GENERATE ANALYTICAL REPORT',
      btn_run_loading: 'RUNNING SYNTHESIS AGENT…',
      btn_run_new:     'GENERATE NEW REPORT',
      placeholder:     'Click "GENERATE ANALYTICAL REPORT" to run the Analysis Agent on database data.',
      running_msg:     'AnalysisAgent is analysing data for sector',
      result_badge:    'REPORT GENERATED',
      result_model:    'MODEL',
