...
const TRANSLATIONS = {
  fr: {
    ...
    insights: {
      ...
      ds: {
        freshness_title:    'Fraîcheur des Données par Secteur',
        refresh_btn:        'Actualiser',
        refreshing:         'Actualisation…',
        refreshed_at:       'Actualisé à',
        obs_suffix:         'obs.',
        days_suffix:        'j',
        correlations_title: 'Corrélations Cross-Secteurs',
        spatial_coverage:   'Couverture spatiale',
        provinces:          'provinces',
        th_sector_a:        'Secteur A',
        th_sector_b:        'Secteur B',
        th_strength:        'Force',
        th_lag:             'Décalage',
        th_interpretation:  'Interprétation',
        no_lag:             'Aucun',
        month:              'mois',
        months:             'mois',
        status: {
        ...
        strength: {
          ...
          weak:              'Faible',
          none:              'Nulle',
          insufficient_data: 'Insuf. données',
        },
        interp_insufficient: 'Données insuffisantes pour établir une corrélation fiable (minimum 4 points mensuels requis par secteur).',
        interp_fmt:          'Corrélation {dir} ({str}){lag} entre {a} et {b} (r = {r}) : quand {a} évolue, {b} tend à {trend}.',
        dir_pos:             'positive',
        dir_neg:             'négative',
        lag_fmt:             ' avec un décalage de {n} {unit}',
        trend_increase:      'augmenter',
        trend_decrease:      'diminuer',
      },
    },
  ...
  en: {
    ...
    insights: {
      ...
      ds: {
        freshness_title:    'Data Freshness by Sector',
        refresh_btn:        'Refresh',
        refreshing:         'Refreshing…',
        refreshed_at:       'Refreshed at',
        obs_suffix:         'obs.',
        days_suffix:        'd',
        correlations_title: 'Cross-Sector Correlations',
        spatial_coverage:   'Spatial coverage',
        provinces:          'provinces',
        th_sector_a:        'Sector A',
        th_sector_b:        'Sector B',
        ...
        interp_insufficient: 'Insufficient data to establish a reliable correlation (minimum 4 monthly points required per sector).',
        interp_fmt:          '{dir} correlation ({str}){lag} between {a} and {b} (r = {r}): as {a} changes, {b} tends to {trend}.',
        dir_pos:             'Positive',
        dir_neg:             'Negative',
        lag_fmt:             ' with a {n}-{unit} lag',
        trend_increase:      'increase',
        trend_decrease:      'decrease',
      },
    },
    api: {
